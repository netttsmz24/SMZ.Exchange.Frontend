...
import { screeningData } from '../bulkscreening/data';
...
@Component({
  selector: 'app-realtimescreening',
  imports: [
    AgGridAngular
  ],
  templateUrl: './realtimescreening.component.html',
  styleUrl: './realtimescreening.component.css'
})

export class RealtimescreeningComponent {
